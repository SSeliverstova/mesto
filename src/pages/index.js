...
const popupContainerEditProfile =
  popupElementEditProfile.querySelector(".popup__container");
const formElementEditProfile =
  popupContainerEditProfile.querySelector(".popup__form");
...
const popupContainerAddCards =
  popupElementAddCards.querySelector(".popup__container");
const formElementAddCards =
  popupContainerAddCards.querySelector(".popup__form");
const addButton = document.querySelector(".profile__add-button");

const popupElementChangeAvatar = document.querySelector(
  ".popup_type_change-avatar",
);
const popupContainerChangeAvatar =
  popupElementChangeAvatar.querySelector(".popup__container");
const formElementChangeAvatar =
  popupContainerChangeAvatar.querySelector(".popup__form");
...
const AvatarValidator = new FormValidator(validationConfig, formElementChangeAvatar);
